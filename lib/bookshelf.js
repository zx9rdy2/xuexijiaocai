...
var currentDemo,
  ...
  samples = {
    ...
    'xinxijishu1' : {'path' : 'samples/xinxijishu1/'},
    'xinxijishu2' : {'path' : 'samples/xinxijishu2/'},
    'xinxijishu3' : {'path' : 'samples/xinxijishu3/'},
    'xinxijishu4' : {'path' : 'samples/xinxijishu4/'},
    'xinxijishu5' : {'path' : 'samples/xinxijishu5/'},
    'xinxijishu6' : {'path' : 'samples/xinxijishu6/'},
    'xinxijishu7' : {'path' : 'samples/xinxijishu7/'},
    'xinxijishu8' : {'path' : 'samples/xinxijishu8/'}
  },
  status = {
    'unloaded' : 0,
    'loading' : 1,
