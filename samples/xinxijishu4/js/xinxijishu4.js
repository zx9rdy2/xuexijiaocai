...
var sampleName = 'xinxijishu4',
	samplePath = 'samples/xinxijishu4/';

function loadPage(page) {

	var img = $('<img />');
	img.load(function() {
		var container = $('.xinxijishu4 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.xinxijishu4 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.xinxijishu4').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.xinxijishu4').addClass('animated').removeClass('zoom-in');
				}, 0);
			...
			swipeLeft: function() {
				...
				$('.xinxijishu4').turn('next');

			},

			swipeRight: function() {
				
				$('.xinxijishu4').turn('previous');
