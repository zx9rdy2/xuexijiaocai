...
var sampleName = 'xinxijishu2',
	samplePath = 'samples/xinxijishu2/';

function loadPage(page) {

	var img = $('<img />');
	img.load(function() {
		var container = $('.xinxijishu2 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.xinxijishu2 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.xinxijishu2').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.xinxijishu2').addClass('animated').removeClass('zoom-in');
				}, 0);
			...
			swipeLeft: function() {
				...
				$('.xinxijishu2').turn('next');

			},

			swipeRight: function() {
				
				$('.xinxijishu2').turn('previous');
