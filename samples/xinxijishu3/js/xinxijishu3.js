...
var sampleName = 'xinxijishu3',
	samplePath = 'samples/xinxijishu3/';

function loadPage(page) {

	var img = $('<img />');
	img.load(function() {
		var container = $('.xinxijishu3 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.xinxijishu3 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.xinxijishu3').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.xinxijishu3').addClass('animated').removeClass('zoom-in');
				}, 0);
			...
			swipeLeft: function() {
				...
				$('.xinxijishu3').turn('next');

			},

			swipeRight: function() {
				
				$('.xinxijishu3').turn('previous');
