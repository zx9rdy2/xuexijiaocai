...
var sampleName = 'xinxijishu7',
	samplePath = 'samples/xinxijishu7/';

function loadPage(page) {

	var img = $('<img />');
	img.load(function() {
		var container = $('.xinxijishu7 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.xinxijishu7 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.xinxijishu7').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.xinxijishu7').addClass('animated').removeClass('zoom-in');
				}, 0);
			...
			swipeLeft: function() {
				...
				$('.xinxijishu7').turn('next');

			},

			swipeRight: function() {
				
				$('.xinxijishu7').turn('previous');
