...
var sampleName = 'xinxijishu5',
	samplePath = 'samples/xinxijishu5/';

function loadPage(page) {

	var img = $('<img />');
	img.load(function() {
		var container = $('.xinxijishu5 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.xinxijishu5 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.xinxijishu5').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.xinxijishu5').addClass('animated').removeClass('zoom-in');
				}, 0);
			...
			swipeLeft: function() {
				...
				$('.xinxijishu5').turn('next');

			},

			swipeRight: function() {
				
				$('.xinxijishu5').turn('previous');
